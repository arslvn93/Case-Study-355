const config = {
  "globals": {
    "agents": [
      {
        "name": "Amy Caughlin",
        "imageSrc": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXGi6Rvo690px2pZc5DMbSWA8c43PHrbQV1AQhakkY8sVONq4iEAkAkfNjhy8G_hHcX5I&usqp=CAU",
        "contactDetails": [
          {
            "type": "email",
  ...
  "mainBox": {
    ...
    "sidebar": {
      ...
      "image": {
        "src": "https://salesgenius.s3.ca-central-1.amazonaws.com/uploads/upload-Screenshot2025-10-30at12.15.58.png"
      },
      "paragraphs": [
